...
Use this code for your Google Apps Script project. The tokens have been removed for security.
```javascript
// ==========================================
...
const AUTH_TOKEN = "YOUR_SECRET_AUTH_TOKEN"; 
    ...
    if (event.type === 'message' && event.message.type === 'text') {
      ...
      if (text === 'เช็คตารางเรียน' || text === 'เช็ค' || text === 'สรุป' || text === 'ตารางของฉัน' || text === 'เทส' || text === 'TEST') {
        ...
        if (followedKeys.length > 0) {
          ...
          UrlFetchApp.fetch("[https://api.line.me/v2/bot/message/reply](https://api.line.me/v2/bot/message/reply)", {
...
function sendLineMulticast(userIds, flexContent) {
  ...
  chunks.forEach(chunk => {
    UrlFetchApp.fetch("[https://api.line.me/v2/bot/message/multicast](https://api.line.me/v2/bot/message/multicast)", {
      "method": "post", "contentType": "application/json", "headers": { "Authorization": "Bearer " + LINE_TOKEN },
